        ...
        <div class="xs-w-100 d-flex align-items-center justify-content-between ">
            ...
            <?php else: ?>
                <div class="d-flex align-items-center ml-md-50">
                    <a href="/login" class="btn btn-sm bgColorThemeLeft"><?php echo e(trans('auth.login')); ?></a>
                    <a href="/register" class="btn btn-sm bgColorThemeLeft"><?php echo e(trans('auth.register')); ?></a>
                </div>
            <?php endif; ?>
        </div>
    </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\lms\resources\views/web/default/includes/top_nav.blade.php ENDPATH**/ ?>